...
const rooms = reactive<Room[]>([
  {
    ...
    capacity: 8,
    description: 'Ruangan meeting mewah dengan fasilitas lengkap untuk rapat eksekutif dan presentasi penting.',
    features: ['Proyektor 4K', 'AC', 'WiFi Cepat', 'Whiteboard', 'Sound System'],
    isAvailable: true
  },
  {
    id: 'R002',
    ...
    capacity: 25,
    description: 'Aula konferensi berkapasitas besar dengan teknologi audio-visual terdepan untuk seminar dan workshop.',
    features: ['LED Display', 'Mic Wireless', 'AC Central', 'Catering Area', 'Parking Luas'],
    isAvailable: true
  },
  {
    id: 'R003',
    ...
    capacity: 12,
    description: 'Ruang kreatif yang cocok untuk brainstorming, workshop desain, dan diskusi tim yang interaktif.',
    features: ['Flipchart', 'Bean Bags', 'Inspirational Wall', 'WiFi Premium', 'Coffee Corner'],
    isAvailable: true
  },
  {
    id: 'R004',
    ...
    capacity: 18,
    description: 'Ruang pelatihan dengan layout fleksibel, ideal untuk training, kursus, dan workshop pendidikan.',
    features: ['Meja Portable', 'Smart TV 65"', 'AC', 'Storage Cabinet', 'Natural Light'],
    isAvailable: false
  },
  {
    id: 'R005',
    ...
    capacity: 6,
    description: 'Pod diskusi intim untuk meeting kecil, one-on-one, dan diskusi confidential.',
    features: ['Privacy Glass', 'Comfortable Sofa', 'Mini Fridge', 'Phone Booth Style', 'Soundproof'],
    isAvailable: true
  },
  {
    id: 'R006',
    ...
    capacity: 30,
    description: 'Laboratorium inovasi dengan peralatan modern untuk prototyping, testing, dan presentasi produk.',
    features: ['Lab Equipment', 'High-Speed Internet', 'Presentation Tools', 'Collaboration Space', 'Storage System'],
    isAvailable: true
  }
])
...
<template>
  <div class="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-black">
    ...
    <!-- Header / Navbar -->
    <header class="relative z-20 bg-slate-800/90 backdrop-blur-sm border-b border-slate-700/50 shadow-lg">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16">
          <!-- Logo / Title -->
          <div class="flex items-center">
            <h1 class="text-2xl font-bold bg-gradient-to-r from-blue-300 via-slate-200 to-blue-400 bg-clip-text text-transparent">
          ...
          <div class="flex items-center space-x-4">
            <span class="text-slate-300 text-sm">
              Halo, <span class="font-medium text-blue-400">{{ currentUser.name }}</span> 👋
            </span>
            <button
              @click="handleLogout"
    ...
    <main class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div class="bg-slate-800/90 backdrop-blur-sm rounded-xl shadow-xl shadow-blue-950/20 p-6 border border-slate-700/50 mb-8">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        >
          ...
          <div class="h-48 bg-gradient-to-br from-slate-700 via-blue-800 to-slate-800 relative overflow-hidden">
            <div class="absolute inset-0 flex items-center justify-center">
              <span class="text-6xl opacity-30">🏢</span>
            </div>
            <div class="absolute top-3 right-3 px-2 py-1 bg-black/50 rounded-lg text-xs text-slate-300">
              ID: {{ room.id }}
            </div>
          </div>
    ...
    >
      ...
      >
        ...
        <div class="p-6 space-y-6">
          <!-- Room Details -->
          <div>
            <h3 class="text-lg font-semibold text-slate-200 mb-3">Detail Ruangan</h3>
          ...
          <!-- Date Selection -->
          <div>
            <h3 class="text-lg font-semibold text-slate-200 mb-3">📅 Pilih Tanggal</h3>
            <input
          ...
          <div class="grid grid-cols-2 gap-4">
            <div>
              <h3 class="text-lg font-semibold text-slate-200 mb-3">🕐 Waktu Mulai</h3>
              <input
            ...
            <div>
              <h3 class="text-lg font-semibold text-slate-200 mb-3">🕐 Waktu Selesai</h3>
              <input
          ...
          <!-- Purpose -->
          <div>
            <h3 class="text-lg font-semibold text-slate-200 mb-3">📝 Tujuan Booking</h3>
            <textarea
