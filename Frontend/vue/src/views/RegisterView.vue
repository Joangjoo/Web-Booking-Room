...
const getPasswordStrengthText = (): string => {
  ...
  switch (passwordStrength.value) {
    case 0:
    case 1: return 'Password lemah'
    case 2: return 'Password sedang'
    case 3: return 'Password kuat'
    case 4: return 'Password sangat kuat'
    default: return ''
  }
}
  ...
  <div class="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-slate-900 via-blue-900 to-black">
    ...
    <path fill-rule="evenodd" d="M.458 10C1.732 5.943 5.522 3 10 3s8.268 2.943 9.542 7c-1.274 4.057-5.022 7-9.542 7S1.732 14.057.458 10zM14 10a4 4 0 11-8 0 4 4 0 018 0z" clip-rule="evenodd" />
      ...
      <svg v-else xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
        ...
        <path d="M2 10s3.939 7 8 7a9.958 9.958 0 004.512-1.074l-1.78-1.781a4 4 0 01-5.462-5.462L3.707 2.293A10.014 10.014 0 00.458 10z" />
      </svg>
    </button>
  </div>
      ...
      {{ getPasswordStrengthText() }}
          ...
          <div class="flex items-start space-x-3">
            ...
            <label for="terms" class="text-sm text-slate-400">
              Saya setuju dengan 
              <a href="#" class="text-blue-400 hover:text-blue-300 underline decoration-blue-400">
                Syarat & Ketentuan
              </a> 
              dan 
              <a href="#" class="text-blue-400 hover:text-blue-300 underline decoration-blue-400">
